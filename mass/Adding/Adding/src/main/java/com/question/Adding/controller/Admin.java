...
import com.question.Adding.service.AdminService;
import com.question.Adding.service.QuestionServiceImpl;
...
public class Admin {
    ...
    public List<Questions> getQuestions(@PathVariable int course_id, @PathVariable("level_id") int level_id,
